(function ($) {
  ...
  */
  ...
  ==================================*/
    ...
    const formattedPhoneNumber = "0912 345 6789";
    const emailAddress = "miajuan@gmail.com";
    const socialMediaLinks = {
        facebookmia: "https://www.facebook.com/miajuan726",
        facebook: "https://www.facebook.com/groups/mjfreelancecommunity",
        instagram: "https://www.instagram.com/miajuan26/",
        twitter: "https://www.twitter.com",
        tiktok: "https://www.tiktok.com/@miajuan26",
        linkedin: "https://www.linkedin.com/",
        youtube: "https://www.youtube.com/@miajuan26",
        threads: "https://www.threads.net/@miajuan26",
        discord: "https://discord.com/invite/faMSMJeVh9"
    };
    
    // Function to update all phone number placeholders
    ...
    // Function to update all email address placeholders
    ...
    function updateSocialMediaLinks() {
        for (const [platform, url] of Object.entries(socialMediaLinks)) {
            const elements = document.querySelectorAll(`.social-media.${platform}`);
    ...
    /*---------- Update Icon for Sliders ----------*/
    $(document).ready(function() {
        // Change the icon for the next button
        $('.slick-next i').removeClass('far fa-arrow-right').addClass('fas fa-arrow-right');
    
        // Change the icon for the previous button (if needed)
        $('.slick-prev i').removeClass('far fa-arrow-left').addClass('fas fa-arrow-left');
    });
